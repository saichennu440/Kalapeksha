...
const events = [
  ...
  },
  {
    ...
    date: 'April 20, 2026',
    location: 'IIM Hyderabad Auditorium',
    tag: 'Talk',
    color: 'bg-primary/5 text-primary border-primary/15',
    accentColor: 'bg-primary/5',
    details: {
      description:
        'A thought-provoking evening talk exploring how traditional craft forms communicate culture, memory, and identity in a post-digital world. Artist and researcher Kavita Sharma will weave together personal narrative, historical inquiry, and live demonstrations of weaving and clay work.',
      duration: '2 hours (6:30 PM – 8:30 PM)',
      capacity: 'Open seating, 200+',
      price: 'Free entry, registration required',
      instructor: 'Kavita Sharma',
      highlights: [
        'Keynote address & live demonstration',
        'Panel discussion with local artisans',
